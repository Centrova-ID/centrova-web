@props(['htmlCode', 'cssCode', 'jsCode', 'title'])
...
@php
    ...
    $editorId = 'monaco-editor-' . uniqid();
    $containerId = 'code-preview-' . uniqid();
@endphp
    ...
    <div id="{{ $containerId }}-code" class="code-preview-code-container">
        ...
        <div class="flex flex-col rounded-2xl overflow-hidden border border-neutral-300">
            <div class="code-preview-editor-container">
                ...
                <div id="{{ $editorId }}" class="code-preview-monaco-editor" style="min-height: 300px; max-height: 600px; overflow: auto;"></div>
            </div>
        </div>
    </div>
