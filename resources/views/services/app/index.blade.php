...
@section('navbar')
    ...
    @include('partials.navbar.subnavbar.services', [
        ...
        'servicesLinkUrl' => route('services.app-development'),
        'menuItems' => [
...
@section('seoMetaTags')
    ...
    <meta property="og:image" content="{{ config('app.url') }}/assets/image/services/app-development/og-image.jpg"/>
    <meta property="og:type" content="website"/>
    <meta property="og:url" content="{{ url('/services/app-development') }}"/>
    ...
    <link rel="canonical" href="{{ url('/services/app-development') }}"/>
@endsection
