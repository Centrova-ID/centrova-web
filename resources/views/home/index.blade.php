    ...
    <div class="relative">
        ...
        <div class="relative">
            {{-- Background image with overlay --}}
                ...
                <img src="https://cdn-dynmedia-1.microsoft.com/is/image/microsoftcorp/Highlight-M365-Icon-Bounce:VP4-1399x600" 
                    class="w-full h-full object-cover" alt="Hero background - Solusi Digital Centrova" loading="eager" decoding="async">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    <div class="glass-card-news rounded-2xl overflow-hidden bg-white text-slate-800 border border-neutral-200 hover:shadow transition-shadow duration-150">
                        <img src="https://plus.unsplash.com/premium_photo-1721080251127-76315300cc5c?q=80&w=870&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="Tim mengembangkan layanan web - Centrova" loading="lazy" decoding="async" class="w-full aspect-video object-cover">
                    ...
                    <div class="glass-card-news rounded-2xl overflow-hidden bg-white text-slate-800 border border-neutral-200 hover:shadow transition-shadow duration-150">
                        <img src="https://images.unsplash.com/photo-1667984390553-7f439e6ae401?q=80&w=1032&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="Infrastruktur dan arsitektur server" loading="lazy" decoding="async" class="w-full aspect-video object-cover">
                        <div class="px-6 py-4 pb-6">
                    ...
                    <div class="glass-card-news rounded-2xl overflow-hidden bg-white text-slate-800 border border-neutral-200 hover:shadow transition-shadow duration-150">
                        <img src="{{ asset('assets/image/home/cs_20251017_17282871894827354.jpg') }}" alt="Dukungan teknis tim Centrova" loading="lazy" decoding="async" class="w-full aspect-video object-cover">
                        <div class="px-6 py-4 pb-6">
                    ...
                    <div class="glass-card-news rounded-2xl overflow-hidden bg-white text-slate-800 border border-neutral-200 hover:shadow transition-shadow duration-150">
                        <img src="{{ asset('assets/image/home/data_security_x7a3m2q9t0l5c1z8n6r4y3b9v1p7f0d5g2s6j8w4k9h1.jpg') }}" alt="Keamanan data dan privasi" loading="lazy" decoding="async" class="w-full aspect-video object-cover">
                        <div class="px-6 py-4 pb-6">
        ...
        <div class="py-10">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="w-full bg-sky-100 rounded-[36px] min-h-[400px] lg:h-[540px] flex items-center justify-center lg:justify-start relative overflow-hidden">
                    <div class="absolute w-full h-full">
                        <img src="{{ asset('assets/image/home/f416765167bbdf72.jpg') }}" class="h-full bg-cover w-full">
                    </div>
                    <div class="max-w-md h-full flex flex-col justify-center text-center lg:text-left z-10 p-8 sm:p-12 lg:p-16">
