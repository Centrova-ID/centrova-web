        ...
        <div class="w-full max-w-6xl mx-auto px-4 sm:px-6 md:px-8 flex flex-col items-center" 
            ...
            <div class="max-w-4xl mx-auto text-center mb-12 px-4 sm:px-6" data-aos="fade-up" data-aos-duration="700" data-aos-once="true">
                <h2 class="text-2xl sm:text-3xl md:text-4xl font-semibold text-neutral-900 mb-3 leading-snug">
                    Solusi All-in-One untuk Transformasi Digital Bisnis Anda
                </h2>
                <p class="text-base sm:text-lg md:text-xl text-slate-700 max-w-2xl mx-auto">
                    Seperti Microsoft 365, tetapi dibuat khusus untuk kebutuhan bisnis Indonesia dengan harga yang terjangkau
                </p>
            </div>

            <div class="w-full mt-10 md:mt-16 grid grid-cols-1 md:grid-cols-3 gap-6">
                <div class="glass-card-news rounded-2xl overflow-hidden bg-white text-slate-800 border border-neutral-200 hover:shadow transition-shadow duration-150">
                    <div class="px-6 py-6 pb-6 text-center">
                        ...
                        <h3 class="text-lg font-semibold text-slate-900 mb-2">Terintegrasi Penuh</h3>
                        <p class="text-sm text-slate-600">Semua aplikasi bisnis terhubung dalam satu platform, menghilangkan silo data dan meningkatkan efisiensi</p>
                    </div>
                </div>
                ...
                <div class="glass-card-news rounded-2xl overflow-hidden bg-white text-slate-800 border border-neutral-200 hover:shadow transition-shadow duration-150">
                    <div class="px-6 py-6 pb-6 text-center">
                        ...
                        <h3 class="text-lg font-semibold text-slate-900 mb-2">Harga Terjangkau</h3>
                        <p class="text-sm text-slate-600">Dibuat khusus untuk pasar Indonesia dengan model harga yang ramah untuk UMKM hingga perusahaan besar</p>
                    </div>
                </div>
                ...
                <div class="glass-card-news rounded-2xl overflow-hidden bg-white text-slate-800 border border-neutral-200 hover:shadow transition-shadow duration-150">
                    <div class="px-6 py-6 pb-6 text-center">
                        <div class="w-16 h-16 bg-red-50 rounded-full flex items-center justify-center mx-auto mb-4">
                            <svg class="w-8 h-8 text-[#ea4335]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z"/>
                            </svg>
                        </div>
                        <h3 class="text-lg font-semibold text-slate-900 mb-2">Implementasi Cepat</h3>
                        <p class="text-sm text-slate-600">Siap pakai dengan modul yang dapat disesuaikan, mengurangi waktu implementasi hingga 70%</p>
                    </div>
                </div>
            </div>
        </div>
