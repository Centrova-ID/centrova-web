                    ...
                    <div class="relative" x-data="{ open: false }">
                        ...
                        >
                            ...
                            <div class="px-2 py-2 space-y-1">
                                <a href="http://account.centrova.test/account" class="flex items-center space-x-3 px-3 py-2 rounded-md text-sm text-gray-700 hover:bg-gray-100 transition-colors">
