...
<header class="sticky top-0 z-50 bg-white border-b border-gray-200">
    ...
    >
        <div class="max-w-[1440px] mx-auto px-8 py-10 grid grid-cols-4 gap-8">
            {{-- Col 1 --}}
            <div>
                <h3 class="text-base font-semibold text-neutral-900 mb-4">Berkembang bersama AI</h3>
                <ul class="space-y-3">
            ...
            {{-- Col 2 --}}
            <div>
                <h3 class="text-base font-semibold text-neutral-900 mb-4">Pengembangan Perangkat Lunak</h3>
                <ul class="space-y-3">
                    ...
                    <div>
                        ...
                        >
                            ...
                            <div>
                                ...
                                <div x-show="aiOpen" x-collapse class="pl-4 space-y-1">
                                    <a href="{{ route('services.ai-strategy') }}" class="block w-full px-5 py-3 text-base font-medium text-neutral-900 active:bg-gray-100 rounded-full">AI Strategy</a>
                                    <a href="{{ route('services.ai-agents') }}" class="block w-full px-5 py-3 text-base font-medium text-neutral-900 active:bg-gray-100 rounded-full">AI Agents</a>
                                    <a href="{{ route('services.ai-automation') }}" class="block w-full px-5 py-3 text-base font-medium text-neutral-900 active:bg-gray-100 rounded-full">AI Automation</a>
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div x-show="softwareOpen" x-collapse class="pl-4 space-y-1">
                                    <a href="{{ route('services.custom-solution.index') }}" class="block w-full px-5 py-3 text-base font-medium text-neutral-900 active:bg-gray-100 rounded-full">Custom Software Development</a>
                                    <a href="{{ route('services.index') }}" class="block w-full px-5 py-3 text-base font-medium text-neutral-900 active:bg-gray-100 rounded-full">Web & Mobile App Development</a>
                                    <a href="{{ route('services.index') }}" class="block w-full px-5 py-3 text-base font-medium text-neutral-900 active:bg-gray-100 rounded-full">Business Systems</a>
                                </div>
                            </div>

                            {{-- Action Links --}}
                            <div>
                                <a href="{{ route('service.consult') }}" class="block w-full px-5 py-3 text-base font-medium text-blue-600 underline active:bg-gray-100 rounded-full">Mulai konsultasi</a>
                                <a href="{{ route('services.index') }}" class="block w-full px-5 py-3 text-base font-medium text-blue-600 underline active:bg-gray-100 rounded-full">Jelajahi layanan</a>
                            </div>
                        </div>
                    </div>

                    {{-- Regular Item: Tentang Kami --}}
                    <a href="{{ route('about') }}" class="block w-full px-5 py-3 text-base font-medium text-neutral-900 active:bg-gray-100 rounded-full">
                        Tentang Kami
                    </a>

                    {{-- Regular Item: Brand --}}
                    <a href="{{ route('brands.index') }}" class="block w-full px-5 py-3 text-base font-medium text-neutral-900 active:bg-gray-100 rounded-full">
                        Brand
                    </a>
                </nav>
            </div>
