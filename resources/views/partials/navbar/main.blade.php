                ...
                <div class="hidden md:flex md:gap-x-2 text-base font-medium text-neutral-800 items-center text-sm text-left">
                    ...
                    <div class="relative group"
                      ...
                      <div x-show="open" x-cloak
                        ...
                        <div class="max-h-[40vh] overflow-y-auto whitespace-nowrap">
                          <a href="{{ route('products.business.index') }}" class="block px-4 pr-12 py-2 text-sm transition hover:bg-gray-50">Centrova Enterprise</a>
                          <div class="border-t border-gray-100 my-1"></div>
                          <a href="{{ route('products.business.crm') }}" class="block px-4 pr-12 py-2 text-sm transition hover:bg-gray-50">CRM</a>
                          <a href="{{ route('products.business.sales') }}" class="block px-4 pr-12 py-2 text-sm transition hover:bg-gray-50">Sales</a>
                          <a href="{{ route('products.business.erp') }}" class="block px-4 pr-12 py-2 text-sm transition hover:bg-gray-50">ERP</a>
                          <a href="{{ route('products.business.pos') }}" class="block px-4 pr-12 py-2 text-sm transition hover:bg-gray-50">POS</a>
                          <a href="{{ route('products.business.rental') }}" class="block px-4 pr-12 py-2 text-sm transition hover:bg-gray-50">Rental</a>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="relative group"
                      ...
                      <div x-show="open" x-cloak
                        ...
                        <div class="max-h-[40vh] overflow-y-auto whitespace-nowrap">
                          <a href="{{ localizedRoute('services.web.index') }}" class="block px-4 pr-12 py-2 text-sm transition hover:bg-gray-50">Pengembangan Web</a>
                          <a href="{{ localizedRoute('services.app.index') }}" class="block px-4 pr-12 py-2 text-sm transition hover:bg-gray-50">Pengembangan Aplikasi</a>
                          <a href="{{ localizedRoute('services.uiux.index') }}" class="block px-4 pr-12 py-2 text-sm transition hover:bg-gray-50">Desain UI/UX</a>
                          <a href="{{ localizedRoute('services.mobile-app.index') }}" class="block px-4 pr-12 py-2 text-sm transition hover:bg-gray-50">Pengembangan Aplikasi Mobile</a>
                          <a href="{{ localizedRoute('services.index') }}" class="block px-4 pr-12 py-2 text-sm transition hover:bg-gray-50">Lihat Semua Layanan</a>
                        </div>
                      </div>
                    </div>
...
<div id="mobileMenu" class="fixed left-0 right-0 bg-white z-40 border-b border-gray-200 -translate-y-full opacity-0 pointer-events-none transition-all duration-700 ease-in-out">
    <div class="px-12 py-8 h-[100vh] overflow-y-auto">
        <div class="space-y-1">
            ...
            <div class="mobile-link py-3 border-b border-gray-100 opacity-0 translate-y-4 transition-all duration-300">
                <div class="text-2xl font-semibold text-gray-700 mb-2">Aplikasi Bisnis</div>
                <div class="ml-4 space-y-2">
                    <a href="{{ route('products.business.index') }}" class="block py-2 text-lg text-gray-600 hover:text-[#128AEB] transition">Centrova Enterprise</a>
                    <a href="{{ route('products.business.crm') }}" class="block py-2 text-lg text-gray-600 hover:text-[#128AEB] transition">CRM</a>
                    <a href="{{ route('products.business.sales') }}" class="block py-2 text-lg text-gray-600 hover:text-[#128AEB] transition">Sales</a>
                    <a href="{{ route('products.business.erp') }}" class="block py-2 text-lg text-gray-600 hover:text-[#128AEB] transition">ERP</a>
                    <a href="{{ route('products.business.pos') }}" class="block py-2 text-lg text-gray-600 hover:text-[#128AEB] transition">POS</a>
                    <a href="{{ route('products.business.rental') }}" class="block py-2 text-lg text-gray-600 hover:text-[#128AEB] transition">Rental</a>
                </div>
            </div>
