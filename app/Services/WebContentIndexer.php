...
class WebContentIndexer
{
    ...
    protected function generateUrlFromViewPath($path)
    {
        ...
        $routeMap = [
            ...
            'services.app-development' => 'services.app-development',
            'services.mobile-app-development' => 'services.mobile-app-development',
            'services.uiux-design' => 'services.uiux-design',
